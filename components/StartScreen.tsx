  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    reader.onload = async (e) => {
        ...
        try {
            ...
            setError(getFriendlyErrorMessage(message, 'Failed to create model'));
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                <label htmlFor="image-upload-start" className="w-full relative flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-md cursor-pointer group hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Select a clear, full-body photo. Face-only photos also work, but full-body is preferred for best results.</p>
                <p className="text-gray-500 dark:text-gray-400 text-xs mt-1">By uploading, you agree not to create harmful, explicit, or unlawful content. This service is for creative and responsible use only.</p>
            ...
            <AnimatePresence>
              {generatedModelUrl && !isGenerating && !error && (
                <motion.div
                  ...
                  className="w-full"
                >
                  <p className="mt-6 text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700 max-w-md">
                    <b>How it works:</b> We create a clean, professional digital model from your photo that perfectly matches your likeness. This ensures the best try-on results.
                  </p>
                  <div
                  ...
                  >
                    <button 
                      onClick={reset}
                      className="w-full sm:w-auto px-6 py-3 text-base font-semibold text-gray-700 dark:text-gray-800 bg-gray-200 dark:bg-gray-300 rounded-md cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-400 transition-colors"
                    >
                      Use Different Photo
                    </button>
                    <button 
                      onClick={() => onModelFinalized(generatedModelUrl)}
                      className="w-full sm:w-auto relative inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-md cursor-pointer group hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors"
                    >
