...
export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path d="M5 11.5 3 12l2 2 .5 3L8 15l2-2" />
        <path d="m21 11.5-2-2-2 2-.5 3 2.5 1.5 2-2" />
    </svg>
);
...
export const QuillIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        ...
        strokeLinejoin="round"
    >
        <path d="M4 10.5c-.5.5-1.2.8-2 .8 1.2 1.2 2.8 2 4.5 2 2.5 0 4.5-2 4.5-4.5 0-2-.8-3.5-2.5-4.5-2-1.5-4.5-2-6.5-2" />
        <path d="m14 11 7 7-4 4-7-7" />
        <path d="m18 15-4-4" />
    </svg>
);
...
export const BlendIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    ...
    strokeLinejoin="round"
  >
    <path d="m18 6 4 4-7 7" />
    <path d="m12 6-4 4 7 7" />
    <path d="M12 18h.01" />
  </svg>
);
